...
?>
Name of evaluator&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input readonly name="noe"  style=" width:18%" type="text" value="<?php  echo $eval_data->FName . " ". $eval_data->LName ;  ?>" ></input><br>
</td>
</tr>
<tr>
<td>
Position of Evaluator&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input readonly name="poe" style=" width:18%"   type="text" value="<?php  echo $eval_data->Position_of_evaluator; ?>" ></input><br>
</td>
</tr>
<tr>
<td>
