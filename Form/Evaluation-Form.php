...
<input name="a3" type="radio"   required>2&nbsp;</input>
...
<td class="tdsize">
<input name="e3" type="radio"   value="6" required >6&nbsp;</input>
<input name="e3" type="radio"   value="7" required>7&nbsp;</input>
<input name="e3" type="radio"   value="8" required>8&nbsp;</input>
<input name="e3" type="radio"   value="9" required>9&nbsp;</input>
<input name="e3" type="radio"   value="10" required>10</input>
 </td>
</tr>
...
<td class="tdsize">
<input name="e4" type="radio"    value="6"  required>6&nbsp;</input>
<input name="e4"  type="radio"   value="7"  required>7&nbsp;</input>
<input name="e4"  type="radio"   value="8"  required>8&nbsp;</input>
<input name="e4"  type="radio"   value="9"  required>9&nbsp;</input>
<input name="e4"  type="radio"   value="10" required>10</input>
 </td>
</tr>
